<template>
    <div class="table-container">
        ...
        <template slot-scope="p">
            ...
            <b-table-column :field="columns[3].field" :label="columns[3].label">{{ p.row.mail }}</b-table-column>
            <b-table-column :field="columns[4].field" :label="columns[4].label">{{ p.row.bleToken }}</b-table-column>
